...
const Expenses = () => {
  ...
  const classNames = {
    ...
    selectInput:
      "mt-1 block w-full pl-3 pr-10 py-2 text-base border border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md bg-white text-gray-900 placeholder-gray-500",
    dateInput:
      "mt-1 block w-full pl-3 pr-10 py-2 text-base border border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md bg-white text-gray-900 placeholder-gray-500",
  };
